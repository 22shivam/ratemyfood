  ...
  return (
    <div className="container mt-6">
        ...
        <div className="col-12 col-md-10 col-lg-8">
            ...
            <div className="row no-gutters align-items-center rounded-3xl shadow-lg hover:shadow-xl transform hover:scale-105 transition duration-500 opacity-70">
              ...
              <div className="col-auto">
                ...
                <button className="btn rounded-4xl font-semibold rounded-lg cursor-pointer" style={{ fontFamily: "comfortaa", fontSize: "20px", backgroundColor: "black", borderRadius: "20px", color: "white" }} onClick={queryAPI}>enter</button>
      ...
      <center>
        ...
        <p style={{fontFamily: "comfortaa", fontSize: "12px", display:"inline"}}>{searchValue}</p>
      </center>
      <br/>
      <br/>
