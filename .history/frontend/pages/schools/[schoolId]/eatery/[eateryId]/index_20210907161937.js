...
export default function Eatery() {
  ...
  return (
    <div className="mt-6">
      ...
      </div> : (data.length === 0) ? <center><span style={{ fontFamily: "comfortaa", fontSize: "14px", fontWeight: "200" }} className="mt-2 grayout">no results found for</span></center>: data.map((food) => {
        return (
          <div key={food._id}>
            <center>
